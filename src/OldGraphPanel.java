...
public class OldGraphPanel extends JPanel {
    ...
    private void drawGraphArea(Graphics2D graphic) {
        ...
        graphic.fillPolygon(new int[]{PolygonData.X_POINTS[0] + arcValue / 2, PolygonData.X_POINTS[1], PolygonData.X_POINTS[2]}, new int[]{PolygonData.Y_POINTS[0], PolygonData.Y_POINTS[1], PolygonData.Y_POINTS[2] + arcValue / 2}, PolygonData.N_POINTS);
    }
